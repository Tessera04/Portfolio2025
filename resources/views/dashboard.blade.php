...
<section class="min-h-screen grid grid-cols-1 lg:grid-cols-2">
        ...
        <div class="bg-black-portfolio p-6 lg:p-12 relative overflow-hidden">
            ...
            <div class="mt-24 lg:mt-32 space-y-6">
                <div>
                    <h1 class="text-mint text-3xl lg:text-5xl font-bebasNeue">Matias Gonzalez</h1>
        ...
        <div class="bg-green p-6 lg:p-12 relative hidden lg:block">
            ...
            <div class="relative mt-12 mx-auto max-w-md" id="imageContainer">
                ...
                <div class="relative aspect-[4/5] bg-green overflow-hidden">
                    <img src="{{ asset('img/profile-pic.png') }}" alt="Portrait photo" class="object-cover w-full h-full bg-grey">
                </div>
...
<section class="min-h-screen flex flex-col items-center justify-center bg-black-portfolio">
    ...
    <form action="">
        @csrf
        <input type="text" class="w-full p-4 mb-4 border rounded-lg placeholder-green border-green bg-black text-white focus:outline-none focus:border-grey" placeholder="Tu nombre" required>
        <input type="email" class="w-full p-4 mb-4 border rounded-lg placeholder-green border-green bg-black text-white focus:outline-none focus:border-grey" placeholder="Tu correo electrónico" required>
        <textarea class="w-full p-4 mb-4 border rounded-lg placeholder-green border-green bg-black text-white focus:outline-none focus:border-grey" rows="5" placeholder="Tu mensaje" required></textarea>
        <button type="submit" class="w-full py-3 bg-green hover:bg-olive text-black font-bold rounded-lg hover:bg-indigo-500 transition-colors">
            Enviar
        </button>
    </form>
</section>
